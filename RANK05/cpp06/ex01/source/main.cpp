...
int	main( void )
{
	...
	std::cout << GREEN << "-> " YELLOW "Person 1" RESET " (Address): " << MAGENTA << ptr1 << RESET << std::endl;
	...
	std::cout << GREEN << "-> " YELLOW "Person 2" RESET " (Address): " << MAGENTA << ptr2 << RESET << std::endl;
	...
	std::cout << GREEN << "-> " YELLOW "Person 1" RESET " (Address): " << MAGENTA << deserializedPtr1 << RESET << std::endl;
	...
	std::cout << GREEN << "-> " YELLOW "Person 2" RESET " (Address): " << MAGENTA << deserializedPtr2 << RESET << std::endl;
